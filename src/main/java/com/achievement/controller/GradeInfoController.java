...
public class GradeInfoController {
  ...
  public ResultEntity insert(@Valid @RequestBody GradeInfo gradeInfo, BindingResult bindingResult) {
    if (bindingResult.hasErrors()) {
      return ResultUtil.error(bindingResult.getFieldError().getDefaultMessage());
    }
  ...
  public ResultEntity update(@Valid @RequestBody GradeInfo gradeInfo, BindingResult bindingResult) {
    if (bindingResult.hasErrors()) {
      return ResultUtil.error(bindingResult.getFieldError().getDefaultMessage());
    }
