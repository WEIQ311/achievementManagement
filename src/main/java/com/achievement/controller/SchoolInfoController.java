...
public class SchoolInfoController {
  ...
  public ResultEntity insert(@Valid @RequestBody SchoolInfo schoolInfo, BindingResult bindingResult) {
    if (bindingResult.hasErrors()) {
      return ResultUtil.error(bindingResult.getFieldError().getDefaultMessage());
    }
  ...
  public ResultEntity update(@Valid @RequestBody SchoolInfo schoolInfo, BindingResult bindingResult) {
    if (bindingResult.hasErrors()) {
      return ResultUtil.error(bindingResult.getFieldError().getDefaultMessage());
    }
